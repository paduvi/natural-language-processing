...
```sh
docker run -it --rm -p 127.0.0.1:8080:8080 --name coursera-aml-nlp akashin/coursera-aml-nlp
```
...
```sh
docker run -it --rm -p 127.0.0.1:8080:8080 --name coursera-aml-nlp -v $PWD:/root/coursera akashin/coursera-aml-nlp
```
